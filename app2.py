...
explicaciones_variables = {
    ...
    'mld': "La desviación logarítmica media (MLD) es una medida de desigualdad que mide la dispersión logarítmica de los ingresos con respecto a la media. Un valor más alto indica mayor desigualdad. Como se puede ver en los gráficos, esta variable presenta una clara asimetría positiva, acumulándose la mayoría de los casos en los valores más bajos.",
